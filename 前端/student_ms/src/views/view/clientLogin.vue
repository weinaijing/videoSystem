<template>
        ...
        <div id="login">
            ...
            <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="demo-form"
                ...
                <el-form-item label-width="0px" prop="username">
                    <el-input v-model="form.stu_name" placeholder="请输入帐号" prefix-icon="User" />
                </el-form-item>
                ...
                <el-form-item label-width="0px" prop="sendToEmail">
                    <el-input v-model="form.sendToEmail" placeholder="请输入邮箱" prefix-icon="Lock" />
                </el-form-item>
                <el-form-item label-width="0px" prop="captcha">
                    <el-input v-model="form.captcha" placeholder="请输入验证码" prefix-icon="Lock" />
    ...
    <el-dialog v-model="registeredDialogVisible" title="注册" width="350px" :before-close="handleClose">
        <el-form :model="registeredForm" label-width="120px" :rules="registeredFormRules" ref="addFormRef">
            ...
            <el-form-item label-width="0px" prop="sendToEmail">
                <el-input v-model="registeredForm.sendToEmail" placeholder="请输入邮箱" prefix-icon="Lock" />
            </el-form-item>
            <el-form-item label-width="0px" prop="captcha">
                <el-input v-model="registeredForm.captcha" placeholder="请输入验证码" prefix-icon="Lock" />
    ...
    methods: {
        ...
        async login() {
            ...
            if (this.form.getcaptcha != this.form.captcha) {
                ...
                const results = await this.$http.post('/clientlogin', qs.stringify(this.form));
                console.log(results);
